...
export function Sidebar() {
	...
	return (
		<>
			<div className="bg-black w-1/4 h-full bg-slate-900 p-2 pt-6 text-white flex justify-center">
				<div className="bg-translucentWhite w-[95%] h-[48%] text-white rounded-xl p-3 text-xl">
					Categories
					<div className="h-5/6 w-full bg-slate-900 rounded-xl mt-3 grid items-center grid-rows-4">
						{
